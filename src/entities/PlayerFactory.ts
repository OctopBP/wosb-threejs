import { createMovementConfig, MovementConfigPreset } from '../config/MovementPresets'
import {
    InputComponent, MovementConfigComponent, PlayerComponent, PositionComponent,
    RenderableComponent, VelocityComponent
} from '../ecs/Component'
